...
async def list_agents(config: Dict[str, Any] = Depends(get_config)):
    """
...
async def get_agent(agent_id: str, config: Dict[str, Any] = Depends(get_config)):
    """
...
async def create_agent(agent_id: str, agent_config: AgentConfig):
    """
