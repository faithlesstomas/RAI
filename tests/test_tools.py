...
class TestSendNotification:
    ...
    def test_send_notification_success(self, mock_session_bus) -> None:
    ...
    def test_send_notification_failure(self, _mock_session_bus) -> None:
...
class TestTakeScreenshot:
    ...
    def test_success(self, mock_dt, mock_run, _mock_exists,
                     mock_b64, mock_open, mock_remove) -> None:
    ...
    @patch('rai.tools.gnome.subprocess.run')
    def test_capture_fails(self, mock_run) -> None:
    ...
    @patch('rai.tools.gnome.subprocess.run')
    def test_file_not_found(self, _mock_run, _mock_exists) -> None:
...
class TestWeather:
    ...
    @patch('rai.tools.gnome.pydbus.SessionBus')
    def test_dbus_error(self, mock_session_bus) -> None:
